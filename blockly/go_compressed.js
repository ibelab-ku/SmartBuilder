...
Blockly.Go.chaincode_init_body = function(block) {
	var statements_init_func = Blockly.Go.statementToCode(block, 'init_func');
	var statements_body_func = Blockly.Go.statementToCode(block, 'body_func');
	// TODO: Assemble Go into code variable.
	...
	code += 'func (t *SimpleChaincode) Invoke(stub *shim.ChaincodeStub, function string, args []string) ([]byte, error) {\n';
	code += '    fmt.Println("ex02 Invoke")\n';
	code += '    if function == "invoke" {\n';
	code += '      fmt.Printf("Function is invoke")\n';
	code += '      return t.invoke(stub, args)\n';
